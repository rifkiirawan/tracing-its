...
<h1>Laporan Harian: {{ Auth::user()->nama }}</h1>
@stop
        ...
        <div class="row">
            <div class="col">
                <div class="row mt-3 mb-5">
                    <div class="col">
                        <a href="#" class="btn btn-success mx-1">Tambah Laporan</a>
                        <a href="#" class="btn btn-primary mx-1">Lapor Hasil SWAB/Rapid</a>
                        <a href="#" class="btn btn-warning mx-1">Lapor Lokasi Isolasi</a>
                    </div>
                </div>
                <div class="timeline">
                    @if($laporan)
